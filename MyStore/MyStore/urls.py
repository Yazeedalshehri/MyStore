...
urlpatterns = [
    ...
    path('<slug:slug>/Analytics/',views.Analytics , name = "Analytics"),
    ...
    path('<slug:slug>/Orders/',views.Orders ,name="Orders"),
    ...
    path('store/UpdateItem/',views.UpdateItem , name='UpdateItem'),
